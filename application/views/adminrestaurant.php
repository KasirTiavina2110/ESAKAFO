			...
			<div class="container">
					<div class="row">
							<section class="12u 12u$">
								<h2><?php echo $table ;?> du restaurant <?php echo $nom_restaurant ;?></h2>
								<form action="<?php echo base_url('plat_controller/insertionplat') ;?>" method="post">
								<input name="idrestaurant" value="<?php echo $nom_resto ;?>" hidden/>
								<?php
									$a=0;
										...
										<table>
											...
											<tbody>
												<?php for($i=0; $i<count($admin_data); $i++) { ?>
													...
													<form action="<?php echo base_url('plat_controller/supprimer/'.$admin_data[$i][0].'/'.$nom_resto.'') ;?>" method="GET">
